...
def ask_llm(question, context):
    prompt = f"""
You are an intelligent document question answering assistant created.
...
st.markdown(
    '<div class="main-title">st.title("AI-Powered Intelligent Document Question Answering System")</div>',
    unsafe_allow_html=True
)
...
<b>Author:</b> Siddhi Milind Kulkarni<br><br>
...
<div class="footer">
<hr>
<b>AI-Powered Intelligent Document Question Answering System</b><br>
Ask Questions. Get Intelligent Answers from Your Documents.<br>
Project developed by Siddhi Milind Kulkarni | Date: 09/05/2026
</div>
""", unsafe_allow_html=True)